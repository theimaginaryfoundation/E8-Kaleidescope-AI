...
- 🧙‍♂️ **Teacher, Explorer, Subconscious**: Agents guide the mind recursively across symbolic terrain.
...
- 🕸️ The emergence rate, $s_Q$, is derived from the projection of a concept's corresponding E8 root vector ($\vec{r}_{Q}$) onto a decoding axis, directly linking geometry to timing.
...
- 🧝‍♂️ **Explorer**: high-entropy free association.
- 🧘‍♀️ **Subconscious**: long-term integration, background summarization.
- 🔁 Recursive dialogue builds hypotheses, tests, refines.

### 🧠 Insight & Evolution

- 🕵️ Novelty detector spots surprising low-coherence clusters.
- 📈 SAC/MPO RL adapts memory tuning over time.
- 🛠️ Auto-task manager triggers refinement runs.
...
* 🕸️ Web UI for shells, memory maps, mood overlays
* 🤖 Inference API for downstream tools
* 🛠️ Plugin system for custom agents and tools
